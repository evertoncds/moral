...
jQuery("#wowslider-container1").wowSlider({effect:"stack,stack_vertical",prev:"",next:"",duration:20*100,//******TEMPO SLIDE AQUI
delay:31*100,width:850,height:380,autoPlay:true,autoPlayVideo:false,playPause:false,stopOnHover:true,loop:false,bullets:0,caption:false,captionEffect:"parallax",controls:true,controlsThumb:false,responsive:1,fullScreen:false,gestures:2,onBeforeStep:0,images:0});
